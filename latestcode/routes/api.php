...
Route::get('all-featured', [PassportController::class, 'allFeatured']);
...
Route::middleware('auth:api')->group(function (){
    ...
    // Route::get('featured-user/{id}', [PassportController::class, 'addFeatured']);
});
...
Route::middleware('auth:api')->group(function (){
 ...
 Route::get('reviews-by-product/{id}',[ReviewsController::class ,'allByProduct']);
  Route::get('reviews-by-user/{id}',[ReviewsController::class ,'allByUsers']);
